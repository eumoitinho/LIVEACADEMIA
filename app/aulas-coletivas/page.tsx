...
const modalidades = [
  {
    ...
    image: "https://drive.google.com/file/d/1TOMbbSKeVbREFb5Fdo2HEunLCyHIwSVV/view?usp=sharing"
  },
  {
    nome: "Ubound (Jump)",
    ...
    image: "https://elements.envato.com/pt-br/beautiful-slim-female-exercising-at-yoga-studio-3S246XL"
  },
  {
    nome: "Power",
    ...
    icon: Target,
    categoria: "Força e Resistência",
    image: "https://drive.google.com/file/d/17yT0_02ZajQjL15w41jpdsdcN5-G1v_p/view?usp=sharing"
  },
  {
    nome: "Eleven (HIIT)",
    ...
    icon: Star,
    categoria: "Alta Intensidade",
    image: "https://drive.google.com/file/d/1gFeLrnJO3XHrBAWE1qhbJFpAaMZuPG9k/view?usp=drive_link"
  },
  {
    nome: "Top Ride",
  ...
  },
  {
    ...
    icon: Music,
    categoria: "Dança",
    image: "https://drive.google.com/file/d/1REiHWGYX8lGvrGnSF0eqWO4Y7OMWG-IB/view?usp=sharing"
  },
  {
    nome: "Fitdance",
  ...
  },
  {
    ...
    icon: Users,
    categoria: "Funcional",
    image: "https://elements.envato.com/pt-br/fitness-sport-people-and-lifestyle-concept-group-o-B3AQ6AP"
  },
  {
    nome: "Super Abdômen",
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <div className="flex justify-center mt-6 mb-6">
            <img
              src="https://argentina.radicalfitness.net/wp-content/uploads/2018/03/logo_radical_blanco_footer.png"
              alt="Radical Fitness Brasil"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {modalidades.map((modalidade, index) => (
              <motion.div
                ...
                className="bg-live-bg/50 backdrop-blur-sm p-6 rounded-2xl border border-live-border/30 hover:border-live-accent/50 transition-all duration-300 group"
              >
                {modalidade.image && (
